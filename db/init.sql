...
INSERT INTO stores (name, address, phone, email, opening_time, closing_time, area, postal_code, owner_id, created_at, updated_at) VALUES
...
INSERT INTO business_hours (store_id, day_of_week, is_closed, opening_time, closing_time, created_at, updated_at) VALUES


(2, 0, false, '07:00', '19:00', NOW(), NOW()),
(2, 1, false, '07:00', '19:00', NOW(), NOW()),
(2, 2, false, '07:00', '19:00', NOW(), NOW()),
(2, 3, false, '07:00', '19:00', NOW(), NOW()),
(2, 4, false, '07:00', '19:00', NOW(), NOW()),
(2, 5, false, '07:00', '19:00', NOW(), NOW()),
(2, 6, false, '07:00', '19:00', NOW(), NOW()),
(3, 0, false, '08:30', '20:00', NOW(), NOW()),
(3, 1, false, '08:30', '20:00', NOW(), NOW()),
(3, 2, false, '08:30', '20:00', NOW(), NOW()),
(3, 3, false, '08:30', '20:00', NOW(), NOW()),
(3, 4, false, '08:30', '20:00', NOW(), NOW()),
(3, 5, false, '08:30', '20:00', NOW(), NOW()),
(3, 6, false, '08:30', '20:00', NOW(), NOW()),
(4, 0, false, '09:00', '19:00', NOW(), NOW()),
(4, 1, false, '09:00', '19:00', NOW(), NOW()),
(4, 2, false, '09:00', '19:00', NOW(), NOW()),
(4, 3, false, '09:00', '19:00', NOW(), NOW()),
(4, 4, false, '09:00', '19:00', NOW(), NOW()),
(4, 5, false, '09:00', '19:00', NOW(), NOW()),
(4, 6, false, '09:00', '19:00', NOW(), NOW()),
(5, 0, false, '07:00', '19:00', NOW(), NOW()),
(5, 1, false, '07:00', '19:00', NOW(), NOW()),
(5, 2, false, '07:00', '19:00', NOW(), NOW()),
(5, 3, false, '07:00', '19:00', NOW(), NOW()),
(5, 4, false, '07:00', '19:00', NOW(), NOW()),
(5, 5, false, '07:00', '19:00', NOW(), NOW()),
(5, 6, false, '07:00', '19:00', NOW(), NOW()),
(6, 0, false, '10:00', '19:00', NOW(), NOW()),
(6, 1, false, '10:00', '19:00', NOW(), NOW()),
(6, 2, false, '10:00', '19:00', NOW(), NOW()),
(6, 3, false, '10:00', '19:00', NOW(), NOW()),
(6, 4, false, '10:00', '19:00', NOW(), NOW()),
(6, 5, false, '10:00', '19:00', NOW(), NOW()),
(6, 6, false, '10:00', '19:00', NOW(), NOW()),
(7, 0, false, '07:00', '17:00', NOW(), NOW()),
(7, 1, false, '07:00', '17:00', NOW(), NOW()),
(7, 2, false, '07:00', '17:00', NOW(), NOW()),
(7, 3, false, '07:00', '17:00', NOW(), NOW()),
(7, 4, false, '07:00', '17:00', NOW(), NOW()),
(7, 5, false, '07:00', '17:00', NOW(), NOW()),
(7, 6, false, '07:00', '17:00', NOW(), NOW()),
(8, 0, false, '07:00', '19:00', NOW(), NOW()),
(8, 1, false, '07:00', '19:00', NOW(), NOW()),
(8, 2, false, '07:00', '19:00', NOW(), NOW()),
(8, 3, false, '07:00', '19:00', NOW(), NOW()),
(8, 4, false, '07:00', '19:00', NOW(), NOW()),
(8, 5, false, '07:00', '19:00', NOW(), NOW()),
(8, 6, false, '07:00', '19:00', NOW(), NOW()),
(9, 0, false, '10:30', '18:00', NOW(), NOW()),
(9, 1, false, '10:30', '18:00', NOW(), NOW()),
(9, 2, false, '10:30', '18:00', NOW(), NOW()),
(9, 3, false, '10:30', '18:00', NOW(), NOW()),
(9, 4, false, '10:30', '18:00', NOW(), NOW()),
(9, 5, false, '10:30', '18:00', NOW(), NOW()),
(9, 6, false, '10:30', '18:00', NOW(), NOW());


INSERT INTO staff (store_id, first_name, last_name, furigana, gender, position, employment_type, max_hours_per_month, min_hours_per_month, max_hours_per_day, max_consecutive_days, created_at, updated_at) VALUES
(2, '太郎', '田中', 'タナカ タロウ', '男性', '店長', '正社員', 160, 140, 8, 5, NOW(), NOW()),
(2, '花子', '佐藤', 'サトウ ハナコ', '女性', '副店長', 'パート', 120, 80, 6, 4, NOW(), NOW()),
(3, '次郎', '鈴木', 'スズキ ジロウ', '男性', 'リーダー', 'アルバイト', 100, 60, 8, 5, NOW(), NOW()),
(3, '美咲', '高橋', 'タカハシ ミサキ', '女性', '一般スタッフ', 'パート', 80, 40, 6, 3, NOW(), NOW()),
(4, '健一', '伊藤', 'イトウ ケンイチ', '男性', '店長', '正社員', 160, 140, 8, 5, NOW(), NOW()),
(4, '由美', '渡辺', 'ワタナベ ユミ', '女性', '一般スタッフ', 'アルバイト', 90, 50, 7, 4, NOW(), NOW()),
(5, '雄介', '山本', 'ヤマモト ユウスケ', '男性', 'リーダー', 'パート', 110, 70, 7, 4, NOW(), NOW()),
(5, '麻衣', '中村', 'ナカムラ マイ', '女性', '一般スタッフ', 'アルバイト', 85, 45, 6, 3, NOW(), NOW()),
(6, '大輔', '小林', 'コバヤシ ダイスケ', '男性', '副店長', '正社員', 150, 130, 8, 5, NOW(), NOW()),
(6, '愛', '加藤', 'カトウ アイ', '女性', '一般スタッフ', 'パート', 95, 55, 6, 4, NOW(), NOW());

INSERT INTO staff_day_preferences (staff_id, day_of_week, available, preferred_start_time, preferred_end_time, break_start_time, break_end_time, created_at, updated_at) VALUES
...
(8, 4, true, '12:00', '18:00', '15:00',


INSERT INTO users (username, password, email, company_name, role, parent_user_id, created_at, updated_at) VALUES
...
('staff1_owner1', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff1@owner1.com', NULL, 'staff', 2, NOW(), NOW()),
('staff2_owner1', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff2@owner1.com', NULL, 'staff', 2, NOW(), NOW()),
('staff1_owner2', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff1@owner2.com', NULL, 'staff', 3, NOW(), NOW()),
('staff2_owner2', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff2@owner2.com', NULL, 'staff', 3, NOW(), NOW());